...
//isEmpty method for MovieBST: this tells the user if the MovieBST is empty
	public Boolean isEmptyTree(){
		return root == null;
	}
//findSuccessor method for MovieBST: this is used to find the successor of a specific MovieNode
...
//getParent method for MovieBST: this is used to get the parent of a specific MovieNode
...
//deleteRoot method for MovieBST: this is used to delete the root 
...
//deleteNoKids method for MovieBST: this is used when the MovieNode we're deleting has zero kids
...
//deleteOneKid method for MovieBST: this is used when the MovieNode we're deleting has one kid
...
//deleteTwoKids method for MovieBST: this is used when the MovieNode we're deleting has two kids
...
//delete method for MovieBST: this is used to delete a specific MovieNode
...
//search2 method for MovieBST: this is used to search for a specific MovieNode
...
//search method for MovieBST: this is used to search for a specific MovieNode
...
//insert method for MovieBST: this is used to insert a new MovieNode 'p' into the MovieBST
...
//insert2 method for MovieBST: this is used in correlation with search to insert a new MovieNode 'p' into MovieBST
...
//traverse2 method for MovieBST: this helps traverse print out the tree
	public void traverse2(MovieNode temp){
		if (temp != null){
			traverse2(temp.getLeft());
			System.out.print(temp.getTitle()+":"+temp.getDate()+" ");
			traverse2(temp.getRight());
		}
	}
//traverse method for MovieBST: this is used to print out the MovieBST
	public void traverse(){
		if (root != null){
			traverse2(root.getLeft());
			System.out.print(root.getTitle()+":"+root.getDate()+" ");
			traverse2(root.getRight());
		}
		System.out.println();
	}
//print methods for MovieBST
