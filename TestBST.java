public class TestBST
{
    public static void main(String[] args)
    {
		...
		a.insert(eMovieNode);
		a.insert(fMovieNode);
		System.out.println("Searching release dates:");
		System.out.println(a.search(19390420).getTitle());
		System.out.println(a.search(19490618).getTitle());
		System.out.println(a.search(19411129).getTitle());
		System.out.println(a.search(19500714).getTitle());
		a.traverse();
		a.printTree();
		System.out.println("Searching for release date of: 19490618");
		System.out.println(a.search(19490618).getTitle());
		System.out.println("Deleting release date of: 19390420");
		a.delete(aMovieNode);
		a.traverse();
		a.printTree();
